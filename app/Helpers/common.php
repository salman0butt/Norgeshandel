...
//                }
    ...
    // update notification for property 
       public static function property_notification(Ad $ad, Pusher $pusher,$user_id){

        $notif = new Notification(['notifiable_type' => Ad::class, 'type' => 'property_for_rent', 'user_id' => $user_id, 'notifiable_id' => $ad->id, 'data' => 'Eiendom oppdatert']);
        $notif->save();
