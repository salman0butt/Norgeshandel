                ...
                <div style="border-right:1px solid #ddd;" class="col-md-3">
                    ...
                    <div class="form-group nav-dynamic-checks">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <button name="asking_price_btn" class="dme-btn-outlined-blue float-right">Søk</button>
                            </div>
                        </div>
                    </div>
                    <div class="form-group nav-dynamic-checks">
                        ...
                        <div class="row">
                            <div class="col-sm-4 pr-md-0">
                                <input type="text" class="dme-form-control" name="total_price_sale_add_from">
                                <span class="u-t5">Fra kr</span>
                            </div>
                            <div class="col-sm-4 pr-md-0">
                                <input type="text" class="dme-form-control" name="total_price_sale_add_to">
                                <span class="u-t5">Til kr</span>
                            </div>
                            <div class="col-sm-4">
                                <button name="total_price_btn" class="dme-btn-outlined-blue float-right">Søk</button>
                            </div>
                        </div>
                    </div>
                    <div class="form-group nav-dynamic-checks">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <button name="expense_per_month_btn" class="dme-btn-outlined-blue float-right">Søk</button>
                            </div>
                        </div>
                    </div>
                    <div class="form-group nav-dynamic-checks">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <button name="size_btn" class="dme-btn-outlined-blue float-right">Søk</button>
                            </div>
                        </div>
                    </div>
                    <div class="form-group nav-dynamic-checks">
                    ...
                    <div class="form-group nav-dynamic-checks">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <button name="lot_size_btn" class="dme-btn-outlined-blue float-right">Søk</button>
                            </div>
                        </div>
                    </div>
                    <div class="form-group nav-dynamic-checks">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <button name="year_btn" class="dme-btn-outlined-blue float-right">Søk</button>
                            </div>
                        </div>
                    </div>
                ...
                <div style="border-right:1px solid #ddd;" class="col-md-3">
                    ...
                    <div class="form-group nav-dynamic-checks">
                        ...
                        <ul class="list list-unstyled">
                            <li>
                                <div class="input-toggle">
                                    <input type="checkbox" name="sold_status[]" value="available" id="navCondition">
                                    <label for="navCondition" class="">Til salgs <span data-name="available" data-title="sold_status" class="count"></span></label>
                                </div>
                            </li>
                            <li>
                                <div class="input-toggle">
                                    <input type="checkbox" name="sold_status[]" value="sold" id="navCondition">
                                    <label for="navCondition" class="">Solgt siste 3 dager <span data-name="sold" data-title="sold_status" class="count"></span></label>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div class="form-group nav-dynamic-checks">
                        ...
                        <ul class="list list-unstyled">
                            <li>
                                <div class="input-toggle">
                                    <input type="checkbox" name="condition[]" value="new" id="navCondition">
                                    <label for="navCondition" class="">Brukt bolig <span data-name="used" data-title="condition" class="count"></span></label>
                                </div>
                            </li>
                            <li>
                                <div class="input-toggle">
                                    <input type="checkbox" name="condition[]" value="used" id="navCondition">
                                    <label for="navCondition" class="">Nybygg <span data-name="new" data-title="condition" class="count"></span></label>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div class="form-group nav-dynamic-checks">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <div class="input-toggle">
                                    <input type="checkbox" name="display_date[]" value="{{now()->addDays($i)->toDateString()}}" id="navCondition">
                                    <label for="navCondition" class="">{{now()->addDays($i)->isoFormat("dddd DD. MMMM")}} <span data-name="{{now()->addDays($i)->toDateString()}}" data-title="display_name" class="count"></span></label>
                                </div>
                            </li>
                            @endfor
                        </ul>
