<header class="top-bar fixed-top">
    <div class="nav-container">
        <nav class="navbar navbar-expand-sm mt-0 pt-0 pb-0 desktop-header">
            <a class="navbar-brand desktop-logo" href="{{url('/')}}"><img src="{{asset('public/images/NorgesHondel-logo.png')}}" height="28"></a>
            <a class="navbar-brand mobile-logo pt-2" href="{{url('/')}}"><img src="{{asset('public/images/NorgesHondel-logo-mobile.png')}}" height="28"></a>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav ml-auto" style="">
                    ...
                    {{--<li class="nav-item" id="move_to_notifications">--}}
                        ...
                        {{--</a>--}}
                    {{--</li>--}}
                    <li class="nav-item desktop-header-li">
                        <a class="nav-link position-relative" href="{{url('notifications')}}">
                            @if(\Auth::check())
...
{{--                                     {{ Auth::user()->header_unread_notifications()->count()}}--}}
                    ...
                    <li class="nav-item type-btn desktop-header-li" style="padding-top: 4px; padding-bottom: 2px;">
                        @if(Auth::check())
                    ...
                    <li class="order-sm-0 mobile-header-li ml-2 mr-1">
                        <a class="nav-link position-relative" href="{{url('notifications')}}">
                    ...
                    <li class="order-sm-1 mobile-header-li mx-1">
                        <a class="nav-link" href="{{url('/new')}}">
                            <i class="fas fa-plus nav-icons"></i>
                        </a>
                    </li>

                    <li class="order-sm-2 mobile-header-li mx-1">
                        <a class="nav-link position-relative" href="{{url('/messages')}}">
                            @if(\Auth::check())
                                <span class="badge badge-primary pending position-absolute {{count(\Auth::user()->unread_messages()) ? '' : 'd-none'}}" id="chat-notification" style="left:0">
                            {{count(\Auth::user()->unread_messages()) > 0 ? count(\Auth::user()->unread_messages()): ""}}
                    ...
                    <li class="order-sm-3 mobile-header-li mx-1" style="padding-bottom: 2px;">
                            @if(Auth::check())
