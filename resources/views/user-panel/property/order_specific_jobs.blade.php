                              ...
                              <div class="<?php echo $col==='grid'?'col-sm-4 pr-0':'' ?>">
                                  <a href="#" class="row product-list-item mr-1 p-sm-1 mt-3" style="text-decoration: none;">
                                      ...
                                      <div class="detailed-section <?php echo $col==='grid'?'col-sm-12':'col-sm-8' ?> p-2">
                                            ...
                                            <div class="mt-2">
                                                <div class="area font-weight-bold float-left color-grey">{{$value->primary_rom}} m²</div>
                                                <div class="price font-weight-bold float-right color-grey">{{$value->monthly_rent}} kr</div>
                                            </div>
                                            <br>
                                            <div class="detail u-t5 mt-3 float-left text-muted">Eier (Selveier) • {{$value->property_type}} • {{ $value-> number_of_bedrooms  }} soverom <br>DNB Eiendom AS</div>
