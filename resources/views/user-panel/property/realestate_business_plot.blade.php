                    ...
                    <form action="#" method="post" id="realestate_business_plot" enctype="multipart/form-data">
                        <div class="pl-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input name="valuation1" type="text" class="dme-form-control" placeholder="Kr.">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input name="valuation2" type="text" class="dme-form-control">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <input name="head_line" type="text" class="dme-form-control">
                                    </div>
                                </div>
                            </div>
                            <!--                            text area-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <input name="text_on_link" type="text" class="dme-form-control">
                                    </div>
                                </div>
                            </div>
                            <!--                            full input-->
