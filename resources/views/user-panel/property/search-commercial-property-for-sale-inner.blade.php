...
<div id="commercial_property_for_sale_inner_page" class="dme-container pl-3 pr-3">
    ...
    <div class="row mt-1">
        ...
        <div class="col-md-4 pt-4" id="mobile-view-filter-right">
            ...
            <div class="pt-3 float-left">
                <a href="{{ url('/map/property?property_type=commercial_property_for_sale') }}" class="dme-btn-rounded-back-only" target="_blank"><i class="fa fa-map-marker"></i> <span class="">Vis på kart</span></a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="">
...
{{--                                        alt="" class="img-fluid radius-8" style="height: 174.93px;!important; width:100%">--}}
                                ...
                                @if($property_commercial_property_for_sale->primary_room || $property_commercial_property_for_sale-> rental_income)
                                    <div class="mt-2">
                                        @if($property_commercial_property_for_sale->primary_room)
                                            <div class="area font-weight-bold float-left color-grey">{{$property_commercial_property_for_sale->primary_room}}
                                                m²
                                            </div>
                                        @endif
    ...
    <script>
        ...
        if (wrapper == null){
            ...
            document.getElementById("commercial_property_for_sale_inner_page").style.display = "none";
            location.reload();
        }
    </script>
</div>
