    ...
    <div class="row mt-1">
        ...
        <div class="col-md-4 pt-4" id="mobile-view-filter-right">
            ...
            <div class="pt-3 float-left">
                <a href="{{ url('/map/property?property_type=holiday_home_for_sale') }}" class="dme-btn-rounded-back-only" target="_blank"><i class="fa fa-map-marker"></i> <span class="">Vis på kart</span></a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="">
