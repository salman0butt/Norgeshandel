    ...
    <div class="row">
           <div class="col-md-12 mb-1">
            <div class="profile" style="padding: 10px; background: #fdfdfd; border: 2px dashed #ddd;">
                <img src="@if($banner->media!=null){{asset(\App\Helpers\common::getMediaPath($banner->media))}}@else {{asset('public/admin/images/banners/1280x720.png')}} @endif" id="profile_image"
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$banner->title}}" class="form-control" id="first_name" autofocus name="title"
                            placeholder="Title">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="url" class="form-control" id="url" value="{{ $banner->link }}" autofocus name="url" placeholder="Url">
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="form-group row" data-select2-id="12">
                        <div class="col-md-12" data-select2-id="11">
                            <select class="select2 form-control select2-hidden-accessible" name="banner_group" multiple=""
                                style="height: 36px;width: 100%;" data-select2-id="4" tabindex="-1" aria-hidden="true">
                                <optgroup label="Banner Groups" data-select2-id="16">
                                    <option value="G1" data-select2-id="17" {{ ($banner->banner_group == 'G1' ? 'selected' : '') }}>Group 1</option>
                                    <option value="G2" data-select2-id="18"  {{ ($banner->banner_group == 'G2' ? 'selected' : '') }}>Group 2</option>
                                </optgroup>
                            </select>
      ...
      <div class="row">
        <div class="col-md-6">
                 ...
                 <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                  <input type="number" name="display_time_duration" value="{{ $banner->display_time_duration }}" placeholder="Duration" class="form-control">
                    </div>
                </div>
      </div>
