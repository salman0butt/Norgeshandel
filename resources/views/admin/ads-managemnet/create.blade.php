        ...
        <div class="col-md-4 mb-1">
            <div class="profile" style="padding: 10px; background: #fdfdfd; border: 2px dashed #ddd;">
                <img src="{{asset('public/admin/images/banners/1280x720.png')}}" id="banner_image"
                    style="width:100%; max-height: 600px;min-height:150px;" alt="">
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="url" class="form-control url_http" id="url" value="" autofocus name="url"
                            placeholder="Url">
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="form-group row" data-select2-id="12">
                        <div class="col-md-12" data-select2-id="11">
                            <select class="select2 form-control m-t-15 select2-hidden-accessible" name="banner_group[]"
                                multiple="" style="height: 36px;width: 100%;" data-select2-id="4" tabindex="-1"
                                aria-hidden="true">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <label class="radio-inline p-3">
                        <input type="radio" name="full_banner" value="0" checked>Normal
                    </label>
                    <label class="radio-inline p-3">
                        <input type="radio" name="full_banner" value="1">Full
                    </label>
                </div>
            </div>
