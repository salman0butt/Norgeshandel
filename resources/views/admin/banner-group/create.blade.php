     ...
     <div class="col-md-12">
      ...
      <div class="row" style="margin-top: 20px;">
        <div class="col-md-6">
                  ...
                  <input type="url" name="page_url" id="page_url" class="form-control url_http" placeholder="Link">
                    </div>
                 ...
                 <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                  <input type="datetime-local" name="time_end" placeholder="End Time" class="form-control">
                    </div>
                </div>
      </div>
