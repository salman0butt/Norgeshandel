                        ...
                        <div class="pl-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10 ">
                                        <input name="keywords" value="{{$obj_job->keywords}}" id="keywords" type="text"
                                               class="form-control dme-form-control" required>
                                        <span class="u-t5">{{__('Keywords make it easier for candidates to search for your exact position. Choose up to 5 words you think the candidates are applying for.')}}</span>
                                    </div>
                                </div>
                            </div>
                            <!--                            text area-->
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-10 ">
                                        ...
                                        <span class="u-t5">{{__('Tip. The job description should contain sections on work assignments, desired qualifications and what the employer can offer')}}</span>
                                    </div>
                                </div>
                            </div>
                            <!--                            selection-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 ">
                                        <select name="deadline_type" id="deadline_type"
                                            ...
                                            <option @if(!empty($obj_job->deadline)) selected @endif>{{__('Specify date')}}</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10 ">
                                        <input name="address" id="address" type="text"
                                               class="form-control dme-form-control" required>
                                        <span class="u-t5">{{__('Explain briefly about the access to the accommodation and how to find it, please tell about proximity to road, bus and train.')}}</span>
                                    </div>
                                </div>
                            </div>
                            <!--                            button-->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-10 offset-md-2">
                                        <span class="u-t5">{{__('With Handel Seeker Handling, applicants upload contact information, CV and any application letter directly to Handel. You will be notified by email every time you receive a new application and get a full overview here at the business center.')}}</span>
                                    </div>
                                </div>
                            </div>
                            <!--                            full input-->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 ">
                                        <input name="app_mobile" id="app_mobile" type="text"
                                               class="form-control dme-form-control">
                                    </div>
                                    <label for="app_phone" class="col-md-2 u-t5">{{__('Phone  (optional)')}}</label>
                                    <div class="col-sm-4 ">
                                        <input name="app_phone" id="app_phone" type="text"
                                               class="form-control dme-form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <input type="submit" class="btn btn-primary mb-3 col-12" value="Publiser annonsen!">
