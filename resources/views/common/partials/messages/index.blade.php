...
<div class="row">
    <div class="col-md-12 p-2 bg-maroon-lighter">
        ...
        <a href="{{url('/?handel='.$ad->id)}}" style="float: right;text-align: right">
            ...
            <img
                src="{{is_countable($ad->company_gallery)&&count($ad->company_gallery)>0?asset(\App\Helpers\common::getMediaPath($ad->company_gallery->first())):asset('public/images/image-placeholder.jpg')}}"
