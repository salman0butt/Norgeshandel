                ...
                <div class="row mt-4">
                    <div class="col-md-8">
                        ...
                        <div class="row single-realestate-detail p-3">
                            ...
                            <div class="col-md-6"><span class="font-weight-bold">Omkostninger :</span>&nbsp;<span>{{$property_data->expenses}} m²</span></div>
                            <div class="col-md-6"><span class="font-weight-bold">Totalpris :</span>&nbsp;<span>{{$property_data->total_price}} Kr</span></div>
