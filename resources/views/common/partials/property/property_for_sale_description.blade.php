                ...
                <div class="row mt-4">
                    <div class="col-md-8">
                        ...
                        <div class="row single-realestate-detail p-3">
                            ...
                            <div class="col-md-6"><span class="font-weight-bold">Bruksarea </span>&nbsp;<span>115 m²</span></div>
                            <div class="col-md-6"><span class="font-weight-bold">Eieform </span>&nbsp;<span>{{$property_data->tenure}}</span></div>
                            ...
                            <div class="col-md-12 more_details_section hide">
                                ...
                                <div class="col-md-12"><span class="">Kommunenr: </span>&nbsp;<span> {{$property_data->municipality_number}}</span></div>
                                <div class="col-md-12"><span class="">Gårdsnr: </span>&nbsp;<span> {{$property_data->farm_number}}</span></div>
                                <div class="col-md-12"><span class="">Bruksnr: </span>&nbsp;<span> {{$property_data->usage_number}}</span></div>
                            </div>
