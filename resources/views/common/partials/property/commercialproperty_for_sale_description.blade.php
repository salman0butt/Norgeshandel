            ...
            <div class="row mt-4">
                <div class="col-md-8">
                    ...
                    <div class="row single-realestate-detail p-3">
                        ...
                        <div class="col-md-12 mt-2"><p>{{$property_data->description_simple}}</p></div><div class="col-md-12 font-weight-bold mt-3">Totalpris</div>
                        ...
                        <div class="col-md-6"><span class="font-weight-bold">Type lokale </span>&nbsp;<span>{{rtrim($property_data->property_type,",")}}</span></div>
                        <div class="col-md-6"><span class="font-weight-bold">Bruksarea </span>&nbsp;<span>{{$property_data->use_area}} m²</span></div>
                        ...
                        <div class="col-md-6"><span class="font-weight-bold">Bruttoareal </span>&nbsp;<span>{{$property_data->gross_area_from}} - {{$property_data->gross_area_to}} m²</span></div>
                        ...
                        <div class="col-md-6"><span class="font-weight-bold">Energimerking </span>&nbsp;<span> {{$property_data->energy_grades}}  - {{$property_data->heating_character}} </span></div>

                        <div class="col-md-12 more_details_section hide">
                            <div class="col-md-12"><span class="font-weight-bold">Matrikkelinformasjon </div>
                            <div class="col-md-12"><span class="">Kommunenr: {{$property_data->municipal_number}}</span></div>
                            <div class="col-md-12"><span class="">Gårdsnr: {{$property_data->usage_number}}  </span></div>
                            <div class="col-md-12"><span class="">Bruksnr: {{$property_data->farm_number}}  </span></div>
                        </div>
