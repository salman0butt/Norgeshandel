...
@method('PATCH')
    <div class="pl-3 pr-3">
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-12 pr-md-0">
                    <textarea class="{{Auth::user()->hasRole('company') || Auth::user()->hasRole('admin') || Auth::user()->hasRole('agent') ? 'text-editor' : ''}}" name="description" id="description" cols="30" rows="10">{{ $property_for_rent->description }}</textarea>
