...
<?php
 ...
 @if(Request::is('new/property/sale/ad/*/edit') || Request::is('complete/ad/*'))
  ...
  @endif
    ...
    <input type="hidden" name="latitude" id="latitude" value="{{ $property_for_sale->latitude ?? '' }}">
    <input type="hidden" name="longitude" id="longitude" value="{{ $property_for_sale->longitude ?? '' }}">
    <input type="hidden" name="full_address" id="full_address" value="{{ $property_for_sale->full_address ?? '' }}">
...
omkostninger.
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-12 pr-md-0">
                    <input name="offer_url" type="text" value="{{ $property_for_sale->offer_url }}" placeholder="webside.no" class="dme-form-control url_http">
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-12 pr-md-0">
                    <input name="video" type="text" value="{{ $property_for_sale->video }}" class="dme-form-control url_http">
        ...
        @php $obj = $property_for_sale; @endphp
        ...
        <div class="form-group ">
            ...
            <label class="mb-2 form-check-label" for="published-on">
                <input id="published-on" name="published-on" type="checkbox" class="pub_validate" {{$property_for_sale['published-on'] ? 'checked' : ''}}>Ikke vis profilbilde og
