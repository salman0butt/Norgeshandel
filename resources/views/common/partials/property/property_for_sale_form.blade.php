<form action="#" method="post" id="property_for_sale_form" enctype="multipart/form-data">
                        ...
                        <div class="pl-3 pr-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <textarea type="text" name="location" class="dme-form-control" placeholder="F.eks. Eiendommen ligger i nærheten til flotte tur- og friluftsområder og har kort gangavstand til skole og barnehage."></textarea><br>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <input type="text" name="local_area_name" class="dme-form-control" placeholder="F.eks. Bjerke eller Kampen">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="u-t5">Identifikasjonsnummeret til din kommune. Du kan finne ditt kommunenummer på kartverkets hjemmesider.</div>
                                        </div>
                                        <br>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="u-t5">Hvert gårdsnummer er delt inn i bruksnummer, du kan finne dette på kartverkets hjemmesider.</div>
                                        </div>
                                        <br>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="u-t5">Brukes når bruksnummer skal deles inn i flere grunneiendommer. Du kan finne festenummeret til din eiendom på kartverkets hjemmesider.</div>
                                        </div>
                                        <br>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="u-t5">Seksjonsnummer får man tildelt når eiendommen seksjoneres. Du kan finne ditt seksjonsnummer på kartverkets hjemmesider.</div>
                                        </div>
                                        <br>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="u-t5">Leilighetsnummeret består av en H, L, U eller K og fire tall. H står for hovedetasje, 02 for andre etasje og 01 for første bolig til venstre.</div>
                                        </div>
                                        <br>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="u-t5">Bruksarealet er bruttoareal minus den plassen som opptas av yttervegger. Du kan finne bruksarealet i takstrapporten.</div>
                                        </div>
                                        <br>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="u-t5">Arealet av primærrom på eiendommen, sekundærrom tas ikke med i betegnelsen. Du kan finne arealet for primærrom i takstrapporten.</div>
                                        </div>
                                        <br>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="u-t5">Det arealet som bygningen dekker på tomten, det vil si 'fotavtrykket' av bygningen.</div>
                                        </div>
                                        <br>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <textarea name="area_description" type="text" class="dme-form-control" placeholder="F.eks. grunnflate 60m², stue 30m², kjøkken 10m², WC 10m² osv."></textarea><br>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="u-t5">Hvor mange bruksrom er det totalt på eiendommen? (bod og garasje ol. er ikke medregnet)</div>
                                    </div>
                                    <br>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4 input-toggle">
                                        <input data-selector="" id="facilities-AIRCONDITIONING" type="checkbox" value="AIRCONDITIONING" name="facilities[]">
                                    ...
                                    <div class="col-md-4 input-toggle">
                                        <input data-selector="" id="facilities-CHILD-FRIENDLY" type="checkbox" value="CHILD-FRIENDLY" name="facilities[]">
                                        <label class="smalltext" for="facilities-CHILD-FRIENDLY"> Barnevennlig</label>
                                    </div>
                                    <div class="col-md-4 input-toggle">
                                        <input data-selector="" id="facilities-BROADBAND" type="checkbox" value="BROADBAND" name="facilities[]">
                                        <label class="smalltext" for="facilities-BROADBAND"> Bredbåndstilknytning</label>
                                    </div>
                                    <div class="col-md-4 input-toggle">
                                        <input data-selector="" id="facilities-COMMONWASHROOM" type="checkbox" value="COMMONWASHROOM" name="facilities[]">
                                    ...
                                    <div class="col-md-4 input-toggle">
                                        <input data-selector="" id="facilities-NO-NEIGHBOURS-OP" type="checkbox" value="NO-NEIGHBOURS-OP" name="facilities[]">
                                        <label class="smalltext" for="facilities-NO-NEIGHBOURS-OP"> Ingen gjenboere</label>
                                    </div>
                                    <div class="col-md-4 input-toggle">
                                        <input data-selector="" id="facilities-CABLE-TV" type="checkbox" value="CABLE-TV" name="facilities[]">
                                        <label class="smalltext" for="facilities-CABLE-TV"> Kabel-TV</label>
                                    </div>
                                    <div class="col-md-4 input-toggle">
                                        <input data-selector="" id="facilities-CHARGING" type="checkbox" value="CHARGING" name="facilities[]">
                                        <label class="smalltext" for="facilities-CHARGING"> Lademulighet</label>
                                    </div>
                                    <div class="col-md-4 input-toggle">
                                        <input data-selector="" id="facilities-ACCESSIBILITY_LEVEL" type="checkbox" value="ACCESSIBILITY_LEVEL" name="facilities[]">
                                    ...
                                    <div class="col-md-4 input-toggle">
                                        <input data-selector="" id="facilities-PARQUETT" type="checkbox" value="PARQUETT" name="facilities[]">
                                        <label class="smalltext" for="facilities-PARQUETT"> Parkett</label>
                                    </div>
                                    <div class="col-md-4 input-toggle">
                                        <input data-selector="" id="facilities-FIREPLACE" type="checkbox" value="FIREPLACE" name="facilities[]">
                                        <label class="smalltext" for="facilities-FIREPLACE"> Peis/Ildsted</label>
                                    </div>
                                    <div class="col-md-4 input-toggle">
                                        <input data-selector="" id="facilities-QUIET-AREA" type="checkbox" value="QUIET-AREA" name="facilities[]">
                                    ...
                                    <div class="col-md-4 input-toggle">
                                        <input data-selector="" id="facilities-JANITORSERVICE" type="checkbox" value="JANITORSERVICE" name="facilities[]">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="u-t5">Dette er det tinglyste nummeret for din seksjon (leilighet). Dette nummeret oppgis gjerne sammen med gårds- og bruksnummer for å identifisere en seksjon i en boligblokk. Du kan finne ditt andelsnummer på kartverkets hjemmesider.</div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 input-toggle">
                                        <input name="facilities2" data-selector="" id="facilities-AIRCONDITIONING2" type="checkbox" value="AIRCONDITIONING2" name="facilities2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <input name="shared_costs_include" type="text" class="dme-form-control" placeholder="F.eks. kabeltv, strøm, vaktmester, trappevask, forsikring, kommunale avgifter">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4 pr-md-0">
                                        <input name="common_costs_after_interest_free_period"  type="text" class="dme-form-control" placeholder="Kr.">
                                    </div>
                                    <div class="col-md-8"></div>
                                    <div class="col-md-12">
                                        <div class="u-t5">Hva er estimerte felleskostnader etter den eventuelle avdragsfrie perioden? Dette feltet må fylles ut dersom boligen har fellesgjeld. Dersom det ikke er avdragsfrihet i fellesgjeld settes verdien til dagens felleskostnader.</div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <input name="asset_value" type="text" class="dme-form-control total_price_constants" placeholder="Kr.">
                                        <div class="u-t5">Formuesverdi legges til grunn av skatteetaten og kommuner når skatt av boligen skal regnes ut. Mer om formuesverdi og hvordan du beregner dette kan du finne på skatteetaten sin hjemmeside.</div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input type="text" name="asking_price" class="dme-form-control total_price_constants asking_price" placeholder="Kr.">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                    <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="u-t5">Dersom det vil påløpe ekstra omkostninger ved salg av denne eiendommen oppgir du beløpet her. Fyll inn 0 hvis det ikke er ekstra omkostninger.</div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input name="costs_include" type="text" class="dme-form-control total_price_constants costs_include" placeholder="Kr">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                    <div class="col-md-12">
                                        <div class="u-t5">Her kan du gi en mer detaljert beskrivelse av hvilke omkostninger som inngår i kjøpet.</div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input name="percentage_of_public_debt" type="text" class="dme-form-control total_price_constants percentage_of_public_debt" placeholder="Kr.">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                    <div class="col-md-12">
                                        <div class="u-t5">Fellesgjeld for din bolig. Har du ikke fellesgjeld på din bolig setter du denne verdien til 0.</div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
...
<!--                                        <input type="text" class="dme-form-control" placeholder="Kr.">-->
                                    ...
                                    <div class="col-md-12">
                                        <div class="u-t5">Regnes ut som summen av prisantydning, fellesgjeld og omkostninger. Alle disse tre feltene må fylles ut for at totalpris skal vises.</div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="u-t5">Verditakst blir satt av takstmannen og er forventet salgsverdi eller markedsverdien på din eiendom.</div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="u-t5">Lånetakst vil si den boligverdien som banken bruker for lån, pant og eventuelt tvangssalg av boliger. Lånetaksten er basert på verditaksten.</div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 input-toggle">
                                        <input data-selector="" id="facilities-AIRCONDITIONING2" type="checkbox" value="AIRCONDITIONING2" name="facilities3">
                                        <label class="smalltext" for="facilities-AIRCONDITIONING2"> Borettslaget har sikringsordning </label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        ...
                                        <div class="u-t5">Her kan du angi om det praktiseres en forkjøpsrett, eller når en eventuell forkjøpsrett vil bli avklart.</div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 input-toggle">
                                        <input data-selector="" id="facilities-AIRCONDITIONING2" type="checkbox" value="AIRCONDITIONING2" name="facilities4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12 pr-md-0">
                                        <input name="note1[]" type="text" class="dme-form-control" placeholder="F.eks.: visning etter avtale">
                                    </div>
                                    <div class="u-t5">Tid (eksempel 19:30)</div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <button id="add_more_viewing_times_sales" type="button" class="dme-btn-outlined-blue"> + Legg til flere visningstidspunkt</button>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12 pr-md-0">
                                        <input name="phone" type="" class="dme-form-control">
                                        <div class="u-t5">Hvilket telefonnummer ønsker du at interesserte kjøpere skal kontakte deg på?</div>
                                    </div>
                                </div>
                            </div>
