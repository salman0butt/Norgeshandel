        <form action="#" method="post" id="business_for_sale" enctype="multipart/form-data">
                        <div class="pl-3">
                            <!--                            selection-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <select name="country" class="dme-form-control" id="country_code" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <input name="company_name" type="text" class="dme-form-control">
                                    </div>
                                </div>
                            </div>
                            <!--                            full input-->
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <input name="organiztion_number" type="text" class="dme-form-control">
                                    </div>
                                </div>
                            </div>
                            <!--                            small input-->
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input name="price" type="text" class="dme-form-control">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
