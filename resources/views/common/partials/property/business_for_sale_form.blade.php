<form action="#" method="post" id="business_for_sale" class="dropzone addMorePics p-0"
    ...
    @endif
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-12 pr-md-0">
                    <textarea class="{{Auth::user()->hasRole('company') || Auth::user()->hasRole('admin') || Auth::user()->hasRole('agent') ? 'text-editor' : ''}}" name="description" id="description" cols="30" rows="10">{{$business_for_sale_obj->description}}</textarea>
        ...
        @php $obj = $business_for_sale_obj; @endphp
        ...
        <div class="form-group ">
            ...
            <label class="mb-2 form-check-label" for="published-on">
                <input id="published-on" name="published_on" type="checkbox" {{$business_for_sale_obj->published_on ? 'checked' : ''}}>
                Ikke vis profilbilde og lenke til profilsiden
            </label>
        </div>
