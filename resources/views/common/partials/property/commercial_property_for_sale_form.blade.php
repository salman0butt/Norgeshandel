<form action="#" method="post" id="commercial_property_for_sale" enctype="multipart/form-data">
                        <div class="pl-3">
                            <!--                            checkbox -->
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 input-toggle">
                                        <input data-selector="" id="property_type-OTHER" type="checkbox" value="Andre" name="property_type[]">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input name="number_of_office_space" type="text" class="dme-form-control">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input name="number_of_parking_space" type="text" class="dme-form-control">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input name="floors" type="text" class="dme-form-control">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input name="availiable_from" type="date" class="dme-form-control">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <input name="line_text" type="text" class="dme-form-control">
                                    </div>
                                </div>
                            </div>
                            <!--                            full input-->
