<form action="#" method="post" id="property_holiday_home_for_sale_form" enctype="multipart/form-data">
                        <div class="pl-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <input name="local_area_name" type="text" class="dme-form-control" placeholder="F.eks. Bjerke eller Kampen">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 u-t5">Identifikasjonsnummeret til din kommune, du kan finne dette på det lokale kartverkets hjemmesider.</div>
                                    <br>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 u-t5">Nummeret på gårdsenheten, du kan finne dette på det lokale kartverkets hjemmesider.</div>
                                    <br>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 u-t5">Hvert gårdsnummer er delt inn i bruksnummer, du kan finne dette på det lokale kartverkets hjemmesider.</div>
                                    <br>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 u-t5">Seksjonsnummer får man tildelt når eiendommen seksjoneres. Du kan finne ditt seksjonsnummer på det lokale kartverkets hjemmesider.</div>
                                    <br>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 u-t5">
                                        Brukes når bruksnummer skal deles inn i flere grunneiendommer. Du kan finne festenummeret til din eiendom på det lokale kartverkets hjemmesider.</div>
                                    <br>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 u-t5">Bruksarealet er bruttoareal minus den plassen som opptas av yttervegger. Du kan finne bruksarealet i takstrapporten.</div>
                                    <br>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 u-t5">Arealet av primærrom på eiendommen, sekundærrom tas ikke med i betegnelsen. Du kan finne arealet for primærrom i takstrapporten.</div>
                                    <br>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 u-t5">Bruttoareal beskriver arealet av hele boligen, inkludert boder, kjellerrom og så videre, målt fra ytterveggenes yttersider.</div>
                                    <br>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 u-t5">Det arealet som bygningen dekker på tomten, det vil si 'fotavtrykket' av bygningen.</div>
                                    <br>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 u-t5">Innvendig bruksareal unntatt bodarealet. Arealet måles opp innvendig, og man tar ikke med kott, boder, garasje, terrasser, balkonger, altaner og verandaer</div>
                                    <br>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <select name="energy_grade" class="dme-form-control" id="energy_label.class" name="energy_label.class" data-selector="">
                                            <option value=""></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <select name="heating_character" class="dme-form-control" id="property_details.furnishing" name="property_details.furnishing">
                                            <option value=""></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 input-toggle">
                                        <input id="facilities-MAINS_ELECTRICITY" type="checkbox" value="MAINS_ELECTRICITY" name="facilities[]">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input name="joint_board_after_interest_fee_period" type="text" class="dme-form-control" placeholder="Kr.">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        ...
                                        <div class="u-t5">Her bør du spesifisere de månedlige totalkostnadene/husleien, sett gjerne opp hva som er felleskostnader og hva som er renter og avdrag.</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <input type="file" name="property_home_for_sale_photos[]" id="property_home_for_sale_photos" class="" multiple>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        ...
                                        <input type="file" name="property_home_for_sale_pdf_photos[]" id="property_home_for_sale_pdf_photos" class="" multiple>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <button id="add_more_viewing_times_sales" ype="button" class="dme-btn-outlined-blue">+ Legg til flere visningstidspunkt</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group ">
                                ...
                                <label class="mb-2 form-check-label" for="published-on">
                                    <input id="published-on" name="published_on" type="checkbox">Ikke vis profilbilde og lenke til profilsiden før kjøperen tar kontakt med meg.
                                </label>
                            </div>

                            <hr>

                            <input id="publiserannonsen" type="button" class="dme-btn-outlined-blue mb-3 col-12" value="Publiser annonsen!">
