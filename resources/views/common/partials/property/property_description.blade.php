        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="row single-realestate-detail p-3">
                    ...
                    <div class="col-md-12 u-t3">{{number_format($property_data->monthly_rent,0,""," ")}} Kr</div>
                     @endif
                        <div class="bg-light-grey radius-8 col-md-12 p-3">
                        <div class="row">
                 @if (!empty($property_data->include_in_rent))
                    <div class="col-md-12 mt-3"><span class="font-weight-bold">Inkluderer: </span>
                        <span>{{$property_data->include_in_rent}}
                            </span>
                    </div>
                     @endif
                   @if (!empty($property_data->deposit))
                    <div class="col-md-12 "><span class="font-weight-bold">Depositum: </span><span>{{number_format($property_data->deposit,0,""," ")}}</span> Kr</div>
                           </div></div>
                    @endif
                    ...
                    <div class="col-md-12"><span class="font-weight-bold">Handel: </span> <span> {{$property_data->ad ? $property_data->ad->id : ''}}</span></div>
