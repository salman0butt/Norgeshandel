    ...
    <div class="breade-crumb">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-4">
                ...
                @endif
                <div class="mb-2" style="font-weight:500">Husk å bestille/laste ned salgsoppgave så du kan stille godt forberedt på visning.
                </div>
                 ...
                 <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="{{($full_path ? $full_path : asset('uploads/banners/1280x720.png'))}}" alt="First slide">
                        </div>
            ...
            <div class="col-md-8">
                ...
                <div class="row single-realestate-detail p-3">
                    ...
                    <div class="col-md-12 mt-3"><span
                            class="font-weight-bold">Inkluderer:</span><span>{{$property_data->include_in_rent}} Kr
                            </sapn>
                    </div>
