<form action="#" method="post" id="commercial_property_for_rent" enctype="multipart/form-data">
                        <div class="pl-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <textarea name="venue_description" id="beskrivelse" cols="30" rows="10"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input type="text" name="municipal_number" class="dme-form-control">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input type="text" name="usage_number" class="dme-form-control">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input type="text" name="farm_number" class="dme-form-control">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input type="text" name="gross_area_from" class="dme-form-control" placeholder="m²">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input type="text" name="gross_area_to" class="dme-form-control" placeholder="m²">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input type="text" name="land" class="dme-form-control" placeholder="m²">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input type="text" name="number_of_office_space" class="dme-form-control">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input type="text" name="number_of_parking_space" class="dme-form-control">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input type="text" name="floors" class="dme-form-control">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input type="text" name="year_of_construction" class="dme-form-control" placeholder="åååå">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-md-0">
                                        <input type="text" name="rennovated_year" class="dme-form-control" placeholder="åååå">
                                    </div>
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12 text-center mt-5 mb-5 bg-maroon-lighter p-4 radius-8">
                                    <div class="profile-icon">
                                         <img src="{{asset('public/images/profile-1.jpg')}}" 
                            ...
                            <div class="form-group ">
                                ...
                                <label class="mb-2 form-check-label" for="published-on">
                                    ...
                                    lenke til profilsiden før kjøperen tar kontakt med meg.
                                </label>
                            </div>
