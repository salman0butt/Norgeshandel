                    ...
                    <form action="#" method="post" id="property_for_rent_form" enctype="multipart/form-data">
                        ...
                        <div class="pl-3 pr-3">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 input-toggle">
                                        <input data-selector="" id="facilities-AIRCONDITIONING2" type="checkbox" value="AIRCONDITIONING2" name="facilities2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <input type="text" name="include_in_rent" class="dme-form-control" placeholder="F.eks.: Strøm, kabeltv, bredbånd osv.">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        ...
                                        <span class="u-t5">Fortell om hva som er bra med boligen, hva som er inkludert av møbler og innredning osv. Fortell gjerne litt om nabolaget og nærhet til transport.<a href="#" target="_blank">Les mer om FINN hjerterom</a></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-12 pr-md-0">
                                        <button  type="button" id="add_more_viewing_times" class="dme-btn-outlined-blue">+ Legg til flere visningstidspunkt</button>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
