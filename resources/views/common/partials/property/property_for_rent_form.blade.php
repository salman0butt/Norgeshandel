    ...
    <div class="form-group">
        <div class="row">
            <div class="col-sm-6 pr-md-0">
                ...
                <input type="text" name="agent_name[]" class="dme-form-control" required>
            </div>
            <div class="col-sm-6 pr-md-0">
                <label class="u-t5">Stilling</label>
                <input type="text" name="agent_position[]" class="dme-form-control" required>
            </div>
            <div class="col-sm-6 pr-md-0">
                <label class="u-t5">Mobil</label>
                <input type="number" min="1" step="1" name="agent_mobile_no[]" class="dme-form-control" required>
            </div>
